TEST_TICKETS = [
    ...
    },
    {
        ...
        "message": "Getting rate limited but documentation says we should have 1000 requests/hour. We're stuck.",
        "previous_tickets": 8,
    ...
    },
    {
        ...
        "message": "Our security team flagged that your API responses include internal server paths in error logs.",
        "previous_tickets": 20,
